...
public class MainActivity extends Activity {
    ...
    private static final String FILTER_JS="(function(){if(window.__fbAdFilterV28)return;window.__fbAdFilterV28=true;"+
      ...
      "var s=document.getElementById('adfilter-style-v28');if(!s){s=document.createElement('style');s.id='adfilter-style-v28';s.innerHTML=css;document.documentElement.appendChild(s);}"+
    ...
    private static final String PROMO_JS="(function(){if(window.__fbPromoSafeV28)return;window.__fbPromoSafeV28=true;"+
      "function norm(t){return(t||'').replace(/\\s+/g,' ').trim().toLowerCase()}"+
      "function hit(t){t=norm(t);return t.indexOf('skaffa facebook för android')>=0||t.indexOf('skaffa facebook for android')>=0||t.indexOf('get facebook for android')>=0||t.indexOf('facebook är bättre i appen')>=0||t.indexOf('facebook is better in the app')>=0||t==='öppna appen'||t==='öppna app'||t==='open app'||t==='skaffa appen'||t==='get app'}"+
      "function clean(root){root=root||document;var q=root.querySelectorAll?root.querySelectorAll('a,button,[role=dialog]'):[];for(var i=0;i<q.length;i++){var e=q[i],t=norm(e.innerText||e.textContent||'');if(!hit(t))continue;var role=e.getAttribute&&e.getAttribute('role');if(e.tagName==='A'||e.tagName==='BUTTON'||role==='dialog')e.style.setProperty('display','none','important')}}"+
      "clean(document);new MutationObserver(function(ms){for(var i=0;i<ms.length;i++)for(var j=0;j<ms[i].addedNodes.length;j++){var n=ms[i].addedNodes[j];if(n&&n.nodeType===1)clean(n)}}).observe(document.documentElement,{childList:true,subtree:true});setInterval(function(){clean(document)},1200)})();";

    private static final String DARK_ON_JS="(function(){var id='fbwrapper-dark-v28',s=document.getElementById(id);if(!s){s=document.createElement('style');s.id=id;s.textContent='html{background:#111!important;filter:invert(1) hue-rotate(180deg)!important}body{background:#fff!important}img,video,picture,canvas,svg image,[style*=background-image],iframe{filter:invert(1) hue-rotate(180deg)!important}';document.documentElement.appendChild(s)}})();";
    private static final String DARK_OFF_JS="(function(){var s=document.getElementById('fbwrapper-dark-v28');if(s)s.remove()})();";
    private static final String DEX_LAYOUT_JS="(function(){var id='fbwrapper-dex-v28',s=document.getElementById(id);if(!s){s=document.createElement('style');s.id=id;s.textContent='html,body{min-width:100%!important;width:100%!important}body{margin:0 auto!important}body>div:first-child,#root,[role=main]{width:100%!important;max-width:1180px!important;margin-left:auto!important;margin-right:auto!important}main,[role=main]{padding-left:24px!important;padding-right:24px!important;box-sizing:border-box!important}[role=feed]{width:min(760px,72vw)!important;max-width:760px!important;margin-left:auto!important;margin-right:auto!important}[role=article],article{max-width:760px!important;margin-left:auto!important;margin-right:auto!important}';document.documentElement.appendChild(s)}var m=document.querySelector('meta[name=viewport]');if(m)m.setAttribute('content','width=device-width, initial-scale=1.0, maximum-scale=1.0');})();";
    private static final String DEX_OFF_JS="(function(){var s=document.getElementById('fbwrapper-dex-v28');if(s)s.remove()})();";
    private static final String DEX_AD_JS="(function(){if(window.__fbDexAdFilterV28)return;window.__fbDexAdFilterV28=true;"+
      "var css='[data-fb-dex-ad-hidden=\\\"1\\\"]{display:none!important;margin:0!important;padding:0!important;height:0!important;min-height:0!important;overflow:hidden!important}';var st=document.getElementById('fb-dex-adfilter-v28');if(!st){st=document.createElement('style');st.id='fb-dex-adfilter-v28';st.textContent=css;document.documentElement.appendChild(st)}"+
