...
public class MainActivity extends Activity {
    ...
    private static final String DEX_AD_JS="(function(){if(window.__fbDexAdFilterV26)return;window.__fbDexAdFilterV26=true;"+
      "var css='[data-fb-dex-ad-hidden=\\\"1\\\"]{display:none!important;margin:0!important;padding:0!important;height:0!important;min-height:0!important;overflow:hidden!important}';var st=document.getElementById('fb-dex-adfilter-v26');if(!st){st=document.createElement('style');st.id='fb-dex-adfilter-v26';st.textContent=css;document.documentElement.appendChild(st)}"+
    ...
    @Override protected void onResume(){super.onResume();if(web!=null){web.onResume();String u=web.getUrl();if(u==null||u.equals("about:blank"))web.loadUrl(homeUrl());else{applyTheme();applyDexLayout();applyDexAds();web.evaluateJavascript(RESUME_JS,null);applyPlayback();}}}
